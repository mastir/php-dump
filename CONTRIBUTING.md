...
* GitHub Issues: <https://github.com/mastir/php-dump/issues>
...
* mastir/php-dump follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  mastir/php-dump automatically runs tests for pull requests. However,
...
[github]: https://github.com/mastir/php-dump
[issues]: https://github.com/mastir/php-dump/issues
[pull requests]: https://github.com/mastir/php-dump/pulls
